...
- (void)_createdUI
{
    ...
    navigationView.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.5];
    [navigationView.cancleButton setTitle:[NSBundle localizedStringForKey:@"返回"] forState:UIControlStateNormal];
    [navigationView.cancleButton setTitleColor:UIColor.whiteColor forState:UIControlStateNormal];
